        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              AI-Powered Weiqi Platform
            </h1>
            <p className="text-xl text-gray-600 mb-8">
              Experience the future of Weiqi with our comprehensive AI platform designed for players of all levels.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Everything You Need to Master Weiqi
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our platform combines cutting-edge AI technology with intuitive design to provide the ultimate Weiqi experience.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Real-time AI Analysis</h3>
              <p className="text-gray-600 mb-6">
                Get instant feedback on your moves with our advanced AI engine that analyzes positions in real-time.
              </p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Smart Hardware Integration</h3>
              <p className="text-gray-600 mb-6">
                Connect your physical Weiqi board with our smart sensors for seamless digital integration.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Live Streaming & Commentary</h3>
              <p className="text-gray-600 mb-6">
                Stream your games live with AI-powered commentary and analysis for your audience.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
